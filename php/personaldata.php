 ...
 <div class="table-wrapper-scroll-y my-custom-scrollbar">
  ...
  <tbody> 
    <?php foreach ($result as $value) {?>
      <tr>
        <th scope="row"><?php echo $value['person_id'];?></th>
        ...
        <td><a class="btn btn-primary" href="personaledit.php?id=<?php echo $value['person_id']?>">Edit</a>
          <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="personaldelete.php?id=<?php echo $value['person_id']?>">Delete</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
