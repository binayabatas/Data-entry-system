<?php
 include_once 'sessionconfirmation.php';
    ...
    $sql1 = "UPDATE industrial_details SET
      industry_name = '$name',
    industry_location = '$location', established_date = '$date', industry_type = '$type'
      WHERE
      industry_id = $id";
    ...
    if ($res1) {
     ...
     $sql = "SELECT * FROM industrial_details WHERE industry_id = $id";
  ...
  <form method='POST' action="" style="font-size: 16px; height: 410px;">
    <div class="form-group" style="text-align: left;">
      ...
      <label>Industry Name</label>
           <input required type="text" class="form-control" name="indname" value=<?php echo $row['industry_name']; ?>>
    </div>
    
    <div class="form-group">
      <label>Location</label>
      <input type="text" class="form-control" name="location" required value=<?php echo $row['industry_location']; ?>>
    </div>
    <div class="form-group">
