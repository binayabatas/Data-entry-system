    ...
    <?php
      ...
      if ($_POST) {
        ...
        //
        $sql="INSERT INTO `user_details`(`email`, `username`, `password`) VALUES ('$email', '$username', '$encpassword')";
        ...
        {
          echo"<script>alert('Your password does not match!'); window.location='register.php'</script>";
        }
      }
      ?>
  ...
  <div class="page" style="height: 400px; padding: 20px; padding-top: 50px;">
   <center>
    ...
    <form action="" method="POST"> 
      ...
      <div class="form-group">
          <input type="password" class="form-control" style="width: 20%;" name="confirmPassword" placeholder="Confirm password" id="confirmPassword" required>
      </div>
      <div class="form-group">
        <button type="submit" name="login" class="btn btn-danger" style="width: 90px">Register</button>
      </div>   
    </form>
  </center>
</div>   
