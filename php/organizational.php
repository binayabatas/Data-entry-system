<?php
      ...
      if($_POST)
      {
        ...
        $rem ="INSERT INTO organization_details(organization_name, organization_location, established_date, organization_ownership, organization_type) VALUES('$orgname', '$location', '$estdate', '$owned', '$type')";
